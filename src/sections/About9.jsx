...
const About9 = () => {
  return (
    <div className=" h-screen max-h-auto flex items-center justify-center  dark:bg-black ">
      <div className="p-6 flex-col items-center justify-center text-[#97b8ff] ">
        ...
        <div className="  flex justify-center text-center">
          <HoverBorderGradient
            ...
            as="button"
            className="dark:bg-black md:text-2xl text-xl  font-spaceGrotesk-semibold  bg-white text-black dark:text-white flex items-center space-x-2"
          >
