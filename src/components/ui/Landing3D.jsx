...
const Landing3D = () => {
  ...
  return (
    <div
      id="img3d"
      className="  object-contain w-full h-screen flex justify-center items-center"
    >
      <div
        id="imageContainer"
        ref={imageContainerRef}
        className=" object-contain relative md:max-h-[768px] min-h-screen min-w-[70%] md:w-[768px]  "
      >
        <img
          id="myImage"
          className=" object-contain "
          ref={imageElementRef}
          src="src/assets/imges/2.png"
          alt=""
        />
      </div>
    </div>
