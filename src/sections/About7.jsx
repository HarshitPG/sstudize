...
const About7 = () => {
  return (
    <div className=" w-full  bg-black relative flex items-center justify-center">
      <div className=" max-h-auto p-4 w-full min-w-screen min-h-screen md:h-screen md:max-h-screen justify-center items-center lg:grid lg:grid-cols-[60%,40%] grid-rows-1 grid grid-cols-1 gap-4 align-self-center">
