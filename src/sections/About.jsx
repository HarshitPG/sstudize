...
const About = () => {
  return (
    <div className=" h-screen max-h-auto  dark:bg-black ">
      ...
      <div className=" px-4 lg:h-fit w-full min-w-screen  justify-center items-center lg:grid lg:grid-cols-3  lg:grid-rows-1  grid sm:grid-cols-2 sm:grid-rows-[45%,15%] gap-4 grid-cols-1 grid-rows-[25%,20%,20%] align-self-center">
        <div>
          <CardContainer className="inter-var">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[100%] h-auto rounded-xl p-6 border  ">
              <CardItem
                translateZ="50"
